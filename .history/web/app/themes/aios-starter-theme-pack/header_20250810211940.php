		...
		<div class="navwrap">
			<div class="container">
				<div class="header__logo">
					<div class="header__logo--ascend">
						<a href="/"><img src="<?php echo get_template_directory_uri();?>/assets/images/ascend-logo.png" alt=""></a>
					</div>

					<div class="header__logo--douglas">
						<a href="/"><img src="<?php echo get_template_directory_uri();?>/assets/images/douglas.png" alt=""></a>
					</div>
				...
				<!-- <div class="header__contact">
					...
					<div class="header__contact--hamburger">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none" class="menu-icon">
						<circle cx="21" cy="21" r="21" fill="white"/>
						<path d="M8 17H34V19H8V17Z" fill="black"/>
						<path d="M21 24H34V26H21V24Z" fill="black"/>
						</svg>
...
<script>
  document.querySelector('.header__contact--hamburger').addEventListener('click', function() {
